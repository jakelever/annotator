...
if __name__ == "__main__":
	...
	#parser.add_argument('--gzippedDrugList', required=True, type=str)
	parser.add_argument('--drugList', required=True, type=str, help='')
	...
	#with gzip.open(args.gzippedDrugList,"r") as f4:
	...
	for termType,mainDict in zip(['cancer','gene','mutation','drug'],[cancers,genes,mutationKeywords,drugs]):
